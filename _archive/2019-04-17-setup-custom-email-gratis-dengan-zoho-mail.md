...
![Logo Zoho | sumber: zoho.com](/static/img/migrated/blog/img/zoho/zoho-logo.png)
...
![Gambar 1: Masukan nama domain](/static/img/migrated/blog/img/zoho/zoho-1.png)
...
![Gambar 2: Lengkapi data-data yang diperlukan](/static/img/migrated/blog/img/zoho/zoho-2.png)
4. Klik **Sign Up** kembali
![Gambar 3: Konfirmasi data-data](/static/img/migrated/blog/img/zoho/zoho-3.png)
...
![Gambar 4: Verifikasi telepon selular](/static/img/migrated/blog/img/zoho/zoho-4.png)
...
![Gambar 5: Aktifkan autentikasi dua faktor](/static/img/migrated/blog/img/zoho/zoho-5.png)
...
1. Verifikasi Domain.
 ...
 ![Gambar 6: Pilih verifikasi menggunakan CNAME](/static/img/migrated/blog/img/zoho/zoho-6.png)
 ...
 ![Gambar 7: CNAME sudah ditambahkan](/static/img/migrated/blog/img/zoho/zoho-7.png)
 - Kemudian klik **Verify Now**
 ![Gambar 8: Verify Now](/static/img/migrated/blog/img/zoho/zoho-8.png)
 - Kemudian klik **Create Account** (isi sama seperti di step 3 saat mendaftarkan akun)
 ![Gambar 9: Create Administrator Account ](/static/img/migrated/blog/img/zoho/zoho-9.png)

2. Add User
 - Klik **Proceed to Add Users**
 ![Gambar 10: Add User](/static/img/migrated/blog/img/zoho/zoho-10.png)
 - Tambahkan user atau bisa di skip untuk melanjutkan prosesnya.
 ![Gambar 11: Tambah user](/static/img/migrated/blog/img/zoho/zoho-11.png)
 - User sudah ditambahkan, kemudian klik **Back to Setup**
 ![Gambar 12: User sudah ditambahkan](/static/img/migrated/blog/img/zoho/zoho-12.png)
...
3. Create Groups
 ...
 ![Gambar 13: Create Groups 1](/static/img/migrated/blog/img/zoho/zoho-13.png)
 - Klik **Back to Setup** untuk kembali ke **Domain Setup**, atau klik **Add Group** untuk membuat group.
 ![Gambar 14: Create Groups 2](/static/img/migrated/blog/img/zoho/zoho-14.png)

4. Configure Email Delivery
 - Kemudian tambahkan mx record yang tertera pada gambar 15 ke DNS management domain
 ![Gambar 15: Tambahkan MX record pada DNS management](/static/img/migrated/blog/img/zoho/zoho-15.png)
 - Apabila MX record sudah ditambahkan, cek dengan menekan tombol **MX Lookup**
 ![Gambar 17: MX record sudah ditambahkan](/static/img/migrated/blog/img/zoho/zoho-17.png)
 - Kemudian klik **OK** lalu klik **Next**
 ![Gambar 16: MX record sudah ditambahkan](/static/img/migrated/blog/img/zoho/zoho-16.png)

5. SPF/DKIM
 - Tambahkan SPF record pada DNS management domain
 ![Gambar 18: ](/static/img/migrated/blog/img/zoho/zoho-18.png)
 - Klik Procees to Configure DKIM untuk konfigurasi DKIM
 ![Gambar 19: DKIM](/static/img/migrated/blog/img/zoho/zoho-19.png)
 - Klik tombol edit untuk mengaktifkan DKIM
 ![Gambar 20: Edit DKIM](/static/img/migrated/blog/img/zoho/zoho-20.png)
 - Kemudian klik **Add Selector**
 ![Gambar 21: Add Selector](/static/img/migrated/blog/img/zoho/zoho-21.png)
 - Masukan nama Selector kemudian klik **Save**
 ![Gambar 22: Simpan perubahan](/static/img/migrated/blog/img/zoho/zoho-22.png)
 - Tambahkan record TXT yang dihasilkan pada DNS management domain kemudian klik **Verify**
 ![Gambar 23: Tambah record DKIM](/static/img/migrated/blog/img/zoho/zoho-23.png)
 - Pastikan record SPF dan DKIM sudah resolve pada domain
 ![Gambar 24: SPF dan DKIM sudah resolve](/static/img/migrated/blog/img/zoho/zoho-24.png)
 - Klik **Back to Setup**
...
1. Test Kirim email ke email lain
 ...
 ![Gambar 25: Test kirim email](/static/img/migrated/blog/img/zoho/zoho-25.png)
 - Kemudian periksa pada kotak masuk email tujuan
 ![Gambar 26: Email sudah masuk](/static/img/migrated/blog/img/zoho/zoho-26.png)
 - SPF dan DKIM bekerja
 ![Gambar 27: SPF dan DKIM bekerja](/static/img/migrated/blog/img/zoho/zoho-27.png)

2. Test menerima email
 ![Gambar 28: berhasil menerima email](/static/img/migrated/blog/img/zoho/zoho-28.png)
